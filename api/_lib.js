...
async function callClaude(body) {
  if (!CLAUDE_KEY) {
    return { status: 500, body: JSON.stringify({ error: { message: 'CLAUDE_KEY not set in Vercel environment variables' }, content: [{ type: 'text', text: '' }] }) };
  }
...
module.exports = { cors, readBody, httpsPost, callClaude, CLAUDE_KEY };
